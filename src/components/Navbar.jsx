      ...
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center font-poppins">
        <div className="flex items-center text-gray-800 text-2xl font-bold">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-[#FF5A5F]">Eventful</span>
          </Link>
        </div>
        ...
        <div className="flex items-center space-x-6">
          ...
          {role !== "staff" && (
            <Link to="/my-events" className="link-button" aria-label="View My Events">
              My Events
            </Link>
          )}
          {!user ? (
            <>
              <Link to="/login" className="link-button" aria-label="Login to your account">
                Login
              </Link>
              <Link to="/create-account" className="link-button" aria-label="Create a new account">
                Create Account
              </Link>
            </>
          ) : (
